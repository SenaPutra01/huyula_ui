                        ...
                        <div class="padding-4">
                            <div class="row">
                                ...
                                <div class="col s5 m5 right-align">
                                    <h5 class="mb-0 white-text">{{ $successCount }}</h5>
                ...
                <div class="card recent-buyers-card animate fadeUp">
                    <div class="card-content">
                        ...
                        <ul class="collection mb-0">
                            <li class="collection-item avatar">
                                <img src="{{asset('dist/')}}/assets/images/avatar/avatar-7.png" alt="" class="circle" />
                            ...
                            <li class="collection-item avatar">
                                <img src="{{asset('dist/')}}/assets/images/avatar/avatar-3.png" alt="" class="circle" />
                                <p class="font-weight-600">Adam Garza</p>
                                <p class="medium-small">20, January 2019</p>
                                <a href="#!" class="secondary-content"><i class="material-icons">star_border</i></a>
                            </li>
                            <li class="collection-item avatar">
                                <img src="{{asset('dist/')}}/assets/images/avatar/avatar-5.png" alt="" class="circle" />
