<form wire:submit.prevent="softCancelBulk" class="p-6">
    ...
    <div class="flex items-center justify-center w-full mt-3">
        ...
        <label for="softCancel-file" wire:loading.attr='disabled'
            ...
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">File name: <span class="font-semibold">{{
                        $softCancel->getClientOriginalName() }}</span></p>
                <span wire:loading>
                    {{ __('Processing...') }}
                </span>
                @else
            ...
            <input id="softCancel-file" type="file" class="hidden" wire:model='softCancel' />
        </label>
    </div>
    <div class="flex justify-between">
        <div class="mt-6">
            <a href="{{ route('bulk.softCancelFormat') }}" type="button"
