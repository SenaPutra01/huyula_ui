...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->attachMenupermission($mm, ['read'], ['super_admin']);

        $sm = $mm->subMenus()->create(['name' => 'Menu', 'url' => $mm->url . '/menu', 'category' => $mm->category]);
        $this->attachMenupermission($sm, ['create', 'read', 'update', 'delete', 'sort'], ['super_admin']);

        $sm = $mm->subMenus()->create(['name' => 'Role', 'url' => $mm->url . '/roles', 'category' => $mm->category]);
        $this->attachMenupermission($sm, ['create', 'read', 'update', 'delete'], ['super_admin']);
        ...
        $this->attachMenupermission($sm, ['read', 'update'], ['super_admin']);
        ...
        $this->attachMenupermission($sm, null, ['super_admin']);
